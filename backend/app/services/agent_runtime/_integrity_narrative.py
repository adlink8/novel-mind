"""Narrative-domain integrity evaluators（拆分自 structured_output_integrity）。

持有 6 个叙事类信封 evaluator：cited_answer / external_evidence /
world_model_candidate / chapter_analysis / story_arc / skill_evaluation，
及其 Phase 27-29 专属 blocked 常量。所有共享基座（IntegrityDecision、
canonical hash、_check_common_lineage、公共 BLOCKED_*）来自
