    ...
    event_rows = [
        {
            ...
            "exact_time": row.exact_time.isoformat() if row.exact_time else None,
            "relative_anchor_event_id": row.relative_anchor_event_id,
            "relative_relation": row.relative_relation,
            "fuzzy_start": row.fuzzy_start.isoformat() if row.fuzzy_start else None,
            "fuzzy_end": row.fuzzy_end.isoformat() if row.fuzzy_end else None,
