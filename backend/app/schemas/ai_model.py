...
class AIModelConfigCreate(BaseModel):
    ...
    model_id: str = Field(
        ...
        min_length=1,
        max_length=100,
        description="模型标识: gpt-4o, claude-3.5-sonnet 等",
    )
    ...
    tier: str = Field(
        default="balanced", description="层级: quality / balanced / budget"
    )
...
class AIModelTestRequest(BaseModel):
    ...
    test_prompt: str = Field(
        default="Hello, please reply with 'OK'.", description="测试用的提示词"
    )
