...
def test_chunker_lineage_forces_full():
    ...
    d = plan_incremental_delta(
        prev_chapter_hashes=prev,
        current_chapter_hashes=cur,
        prev_chunker_lineage={"chunker_name": "a", "chunker_version": "1", "chunker_config_hash": "c" * 64},
        current_chunker_lineage={"chunker_name": "b", "chunker_version": "1", "chunker_config_hash": "c" * 64},
    )
