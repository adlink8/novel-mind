...
def test_tree_invariants_and_rebuild():
    ...
    tree = build_chapter_hierarchy(novel_id=1, chapter_id=10, chapter_number=1, content=text)
...
def test_deterministic_tree_checksum():
    text = "确定性层级。" * 30
    a = build_chapter_hierarchy(novel_id=2, chapter_id=1, chapter_number=1, content=text)
    b = build_chapter_hierarchy(novel_id=2, chapter_id=1, chapter_number=1, content=text)
...
def test_scene_expand_and_fallback():
    ...
    tree = build_chapter_hierarchy(novel_id=3, chapter_id=5, chapter_number=2, content=text)
