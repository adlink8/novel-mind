...
def test_worst_case_gate():
    led = BudgetLedger(BudgetConfig(max_boundaries_per_run=2, max_total_input_tokens=100, max_input_tokens_per_call=50, max_attempts_per_boundary=2, max_total_output_tokens=1000))
...
async def test_worst_case_skip_no_llm_calls():
    ...
    led = BudgetLedger(BudgetConfig(max_boundaries_per_run=0, max_total_input_tokens=1, max_total_output_tokens=1))
