"""Shared fixtures for PromptRevision review PostgreSQL API tests (Phase 32-04).

Migrate the CI database once per module; tests isolate via unique usernames.
"""
...
async def api_client(migrated_postgres: str):
    """ASGI client bound to module-migrated PostgreSQL."""
