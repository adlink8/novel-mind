...
代码实现 ← 第二事实来源
    ↑
GSD 状态（.gsd/STATE.md） ← 项目演进的"当前光标"
    ↑
...
| GSD（`.gsd/`） | 项目阶段、演进、任务、当前状态 | AI Agent、维护者 | 每个 milestone/slice 完成时 |
...
完成 milestone / slice → 更新 .gsd/STATE.md + .gsd/phases/
