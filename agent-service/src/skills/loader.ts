...
/** 25.2 允许加载的技能目录集（单一 allowlist；27-05 加入世界模型技能，28-05 加入叙事记忆技能，29-05 加入评估技能，30-05 加入 Visual Bible 技能，31-04 加入关键场景检测技能，32-05 加入 Scene Spec/Prompt 编译技能，33-05 加入插图生成技能，34-05 加入锚点提议技能，35-05 加入 canon fork 技能）。 */
